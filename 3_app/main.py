...
mongo_uri = "mongodb+srv://athirakj15:08Zd42smiPjKWZu0@cluster0.wzshgbs.mongodb.net/"
client = pymongo.MongoClient(mongo_uri)
db = client["BusinessCard"]
collection = db["ExtractedInfo"]
...
def save_data():
    ...
    # Here, you can process and save the data to MongoDB
